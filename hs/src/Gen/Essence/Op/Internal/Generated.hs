...
allOps con = 
 ...
 (possible (Proxy :: Proxy (OpAllDiff a))          , (K_OpAllDiff        , MkOpAllDiff         <$> give con ))
  ...
  , (possible (Proxy :: Proxy (OpIn a))               , (K_OpIn             , MkOpIn              <$> give con ))
  , (possible (Proxy :: Proxy (OpIndexing a))         , (K_OpIndexing       , MkOpIndexing        <$> give con ))
  ...
  , (possible (Proxy :: Proxy (OpLexLt a))            , (K_OpLexLt          , MkOpLexLt           <$> give con ))
