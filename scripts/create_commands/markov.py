...
echo "INSERT OR REPLACE INTO markov('method', 'essence', 'total_timeout', 'models_timeout', 'races', 'influence_radius', 'radius_as_percentage', 'chain_length', 'run_no', 'output_dir') \
