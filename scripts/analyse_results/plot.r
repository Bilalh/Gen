...
# essences_= c('prob013-PPP', 'prob034-Warehouse', 'prob013-PPP-8-5-12')
essences_= c('prob034-Warehouse')
# essences_= c('prob013-PPP-8-5-12')
...
plot_data <- sall
# plot_data <- subset(sall, 
# #                     method_opts2 %in% method_opts2_  &
#                     essence %in% essences_ &
#                     races %in% races_  &
#                     group_num %ni% group_num_neg 
# )
...
q + 
  ...
  geom_point(position = position_jitter(w = 0.00001)) +
